...
public class Topic_27_Wait_05_Explicit_01_Knowledge {
    WebDriver driver;
    ...
    public void TC_01_Url() {
        ...
        // Chờ cho 1 element được phép click: link/button/checkbox/radio
        ...
        explicitWait.until(ExpectedConditions.domPropertyToBe(driver.findElement(By.xpath("")),"","" ));
        ...
        // Chờ cho 1 đoạn code JS được thực thi mà không có ném ra ngoại lệ
        // Ko ném ra: True
        // ném ra: False
        explicitWait.until(ExpectedConditions.javaScriptThrowsNoExceptions("explicitWait.until(ExpectedConditions."));

        // Chờ số lượng element bằng con số cố định nào đó
        ...
        Pattern pattern = Pattern.compile("This is", Pattern.CASE_INSENSITIVE);
        explicitWait.until(ExpectedConditions.textMatches(By.cssSelector(""), pattern));

        // Bắt bược text này trong DOM/HTML
        ...
        explicitWait.until(ExpectedConditions.refreshed(ExpectedConditions.elementToBeClickable(By.xpath(""))));
    }
